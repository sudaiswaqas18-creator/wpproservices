...
export async function seedExtended(connection) {
  ...
  await connection.query(`INSERT INTO guidebooks (title, slug, description, content, download_url, image_url, sort_order) VALUES ?`, [[
    ['WooCommerce Migration Checklist', 'woocommerce-migration-checklist', 'Move products, customers, and orders to WooCommerce without losing URLs or checkout confidence.', 'Covers catalog mapping, gateway tests, redirect plans, staging QA, and post-cutover Search Console checks for store moves.', '/contact', '/section-images/guidebook-woocommerce-migration.jpg', 1],
    ['LearnDash LMS DIY Setup', 'learndash-diy-setup', 'Stand up LearnDash courses, drip rules, and learner access with a launch-ready checklist.', 'Course structure, payments, certificates, instructor roles, and mobile lesson checks before you invite the first cohort.', '/contact', '/section-images/guidebook-learndash-setup.jpg', 2],
    ['44 LearnDash Tips & Tricks', 'learndash-tips-tricks', 'Operator-level LearnDash habits for drip content, progress clarity, and fewer support tickets.', 'From lesson templates to completion rules — practical tips collected from LMS delivery work, not generic LMS marketing copy.', '/contact', '/section-images/guidebook-learndash-tips.jpg', 3],
    ['Top WooCommerce Plugin Guide', 'woocommerce-plugin-guide', 'Choose WooCommerce plugins by job-to-be-done — pricing, inventory, checkout, and care — not by popularity lists.', 'A curated shortlist for performance, SEO hygiene, security, and conversion — with notes on when custom work beats another plugin.', '/contact', '/section-images/guidebook-woocommerce-plugins.jpg', 4],
    ['WordPress Plugin Developer Guide', 'plugin-developer-guide', 'Build maintainable WordPress plugins with hooks, capability checks, and a release workflow editors can trust.', 'Coding standards, security basics, HPOS-aware WooCommerce notes, and deployment steps for agency plugin work.', '/contact', '/section-images/guidebook-plugin-developer.jpg', 5],
  ]]);
