...
async function runSeed(options = {}) {
  ...
  const caseStudies = [
    ['Loyalty Shipping Rules That Cut Cart Friction', 'Anonymized grocery WooCommerce store', 'Returning shoppers paid shipping on every order, which hurt repeat checkouts.', 'Built WooCommerce rules that unlock free shipping for eligible returning customers using order history.', 'Illustrative engagement (anonymized): a grocery-style WooCommerce store needed loyalty shipping without manual coupons. We delivered rule-based shipping at checkout with staging QA before cutover.', 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=1200', 'Repeat Checkouts', 'Clearer rules', 'Cart Completion', 'Fewer blockers', 'Ops Effort', 'Less manual work', 'freshharvest-shipping', 1],
    ['Member-Only LMS With Controlled Access', 'Anonymized private cohort LMS', 'A closed training community needed gated courses beyond stock LMS plugins.', 'Delivered a LearnDash setup with custom access rules, scheduling helpers, and clearer progress views.', 'Illustrative engagement (anonymized): member-only courses and admin tools so staff spend less time fighting access exceptions.', 'https://images.unsplash.com/photo-1501504905252-473a47ee5617?w=1200', 'Course Access', 'Role-gated', 'Admin Hours', 'Fewer exceptions', 'Delivery', 'Staging-first', 'eduvault-lms', 2],
    ['Cart Recovery Sequences for a Fashion Store', 'Anonymized apparel WooCommerce store', 'Generic abandoned-cart tools recovered too few paid orders.', 'Custom recovery triggers and email sequences wired to WooCommerce order events.', 'Illustrative engagement (anonymized): recovery messaging tied to real cart state instead of one-size drip campaigns.', 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200', 'Recovered Carts', 'Event-based', 'Manual Follow-up', 'Reduced', 'Checkout Clarity', 'Improved copy', 'stylebox-cart-recovery', 3],
    ['Attribute-Driven Subscription Pricing', 'Anonymized specialty retail store', 'Subscriptions needed prices that change with product attributes.', 'Custom WooCommerce subscription pricing driven by selected attributes and renewal cycles.', 'Illustrative engagement (anonymized): fewer billing exceptions when option combinations change mid-cycle.', 'https://images.unsplash.com/photo-1574258495973-f010dfbb5371?w=1200', 'Renewals', 'Attribute-aware', 'Pricing Exceptions', 'Fewer tickets', 'Support Load', 'Clearer rules', 'clearview-subscriptions', 4],
    ['Wallet Checkout for Course Access', 'Anonymized online course team', 'Learners needed flexible payment via credits and shared team seats.', 'Wallet-style checkout and team license helpers on a WordPress LMS stack.', 'Illustrative engagement (anonymized): fewer drop-offs when teams buy access in bulk and assign seats later.', 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1200', 'Checkout Path', 'Wallet-ready', 'Seat Assignment', 'Self-serve', 'Manual Seats', 'Reduced', 'learnpoint-wallet', 5],
  ];
