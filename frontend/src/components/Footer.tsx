      ...
      <div className="section-container py-16">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="mt-4 space-y-2.5">
              <li><Link to="/customers" className="text-sm text-gray-400 transition hover:text-secondary">Customers</Link></li>
              <li><Link to="/quotes" className="text-sm text-gray-400 transition hover:text-secondary">Build-Floor Quotes</Link></li>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="mt-4 space-y-2.5 text-sm">
              ...
              <li><Link to="/faq" className="text-gray-400 transition hover:text-secondary">FAQs</Link></li>
